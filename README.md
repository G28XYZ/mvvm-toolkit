...
- Управляемые изменения: `model.service` дает `dirty`, `dumpData` и операции `commit/reject/toInit`, что удобно для форм и черновиков.
...
- Типобезопасность: Vite‑плагин генерирует DI‑типы.
