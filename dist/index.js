...
import be, { cloneDeep as C, isEqual as ft, isObject as ae, isEmpty as pe } from "lodash";
import { makeObservable as mt, reaction as fe, runInAction as dt, observable as N, isObservable as re, computed as et, action as R } from "mobx";
...
const P = (e, n, c) => Reflect.getOwnMetadata(e, n) || c || {}, j = (e, n, c) => Reflect.defineMetadata(e, n, c);
function ai(...e) {
  try {
...
function ue(e, n) {
  const c = (i, s) => {
    const a = String(typeof e == "string" && e || typeof e == "object" && e?.id || s?.name || i?.name), l = P(tt, gt), h = new Proxy({
      target: i,
...
}, Ve = /* @__PURE__ */ Symbol("field-key"), xe = /* @__PURE__ */ Symbol("validation-key"), Ee = /* @__PURE__ */ Symbol("submit-key"), Re = /* @__PURE__ */ Symbol("exclude-key"), je = /* @__PURE__ */ Symbol("prop-from-view-key");
class st {
  /**
   ...
   */
  isInstance(n = {}) {
    return n instanceof st || Object.getOwnPropertyNames(this).some((c) => Object.keys(n).includes(c));
  }
  /**
...
function di(e) {
  const n = (i, s) => {
    const a = new pt({ callback: e, name: String(s) }), l = P(a.metadataKey, i, new Array());
    j(a.metadataKey, [...l, a], i);
  }, c = (i) => {
    i.addInitializer(function() {
...
function hi(e, n) {
  const c = Fe(B(e, n) ? void 0 : e), o = (a, l) => {
    const h = new Dt(Object.assign(Object.assign({}, c), { name: String(l), ctx: null })), m = P(h.metadataKey, a, new Array());
    j(h.metadataKey, [...m, h], a), Object.getOwnPropertyDescriptor(a, l) || Object.defineProperty(a, l, {
      configurable: !0,
      enumerable: !0,
      get() {
        const g = this;
    ...
    a.addInitializer(function() {
      ...
      if (typeof l.initField == "function") {
        const h = new Dt(Object.assign(Object.assign({}, c), { name: String(a.name), ctx: a })), m = P(h.metadataKey, this, new Array());
        j(h.metadataKey, [...m, h], this), l.initField.call(this, String(a.name));
      }
    });
  };
  function s(a, l) {
...
De();
const Ke = new bt(), $ = new Dt(), Ye = new vt(), Ge = new pt();
let _i = (() => {
  var e, n, c, o, i, s, a, l, h, m;
  let p = [], g, D = [], S = [], A, L = [], K = [], U, nt = [], T = [], d, V = [], M = [], z, E = [], w = [], Y, G = [], X = [], q, at = [], rt = [], lt, Mt = [], St = [], kt, wt = [], Tt = [], At, Vt = [], xt = [], Et, Rt = [], jt = [], zt, Ft = [], Pt = [], Lt, Ct = [], Ht = [], Kt, Yt, Gt = [], Nt = [], Bt, Ut, $t, Wt, Jt, Xt, qt, Qt, Zt, te, ee, ie;
  return e = class {
    get initData() {
      return W(this, n, "f");
    }
     ...
     */
    constructor(t = {}, r) {
      this[h] = (b(this, p), b(this, D, !0)), n.set(this, (b(this, S), b(this, L, null))), c.set(this, (b(this, K), b(this, nt, {}))), o.set(this, (b(this, T), b(this, V, {}))), this.draft = (b(this, M), b(this, E, null)), i.set(this, (b(this, w), b(this, G, []))), s.set(this, (b(this, X), b(this, at, []))), a.set(this, (b(this, rt), b(this, Mt, []))), l.set(this, (b(this, St), b(this, wt, -1))), this.initializedFields = (b(this, Tt), b(this, Vt, void 0)), this.legacyInitDone = (b(this, xt), b(this, Rt, !1)), this.rawInitData = (b(this, jt), b(this, Ft, null)), this.options = (b(this, Pt), b(this, Ct, void 0)), this.historyMuted = (b(this, Ht), b(this, Gt, !1)), b(this, Nt), this.options = r, this[oe] = !0, this.init(t), this.autoAttachDevtools(), this.initLegacyFields();
    }
    /**
    ...
    initLegacyFields() {
      ...
      for (const O of r) {
        ...
        if (_ && v in _) {
          ...
          if (!x)
            continue;
          const Q = C(_), Z = x.factory ? x.factory(Q, this) : Reflect.get(Q, x.name), ot = Reflect.get(this, v);
          (!ft(ot, Z) || !u.has(v)) && (this.defineFieldValue(v, Z), Reflect.set(this, v, Z)), u.add(v);
          continue;
        }
    ...
    autoAttachDevtools() {
      var t, r, f, u, _, O, v, k, x, Q, Z, ot;
      const ht = globalThis;
      if (!ht.__MVVM_DEVTOOLS_AUTO__ || ((r = (t = this.options) === null || t === void 0 ? void 0 : t.devtools) === null || r === void 0 ? void 0 : r.enabled) === !1)
        return;
      const se = (v = (_ = (u = (f = this.options) === null || f === void 0 ? void 0 : f.devtools) === null || u === void 0 ? void 0 : u.name) !== null && _ !== void 0 ? _ : (O = this.constructor) === null || O === void 0 ? void 0 : O.name) !== null && v !== void 0 ? v : "Model", ne = ((k = ht.__MVVM_DEVTOOLS_SEQ__) !== null && k !== void 0 ? k : 0) + 1;
      ht.__MVVM_DEVTOOLS_SEQ__ = ne;
      const ye = (Z = (Q = (x = this.options) === null || x === void 0 ? void 0 : x.devtools) === null || Q === void 0 ? void 0 : Q.instanceId) !== null && Z !== void 0 ? Z : `${se}#${ne}`;
      ((ot = globalThis.queueMicrotask) !== null && ot !== void 0 ? ot : ((me) => Promise.resolve().then(me)))(() => He(this, { name: se, instanceId: ye }));
    }
    withHistoryMuted(t) {
      this.historyMuted = !0;
      try {
    ...
    produceDraft(t, r, f) {
      ...
      t && (u = t.split(".")[0], u && !$.fieldInstance(u, this).collectChanges) || (Oe(this.draft, (O) => {
        if (t) {
          ...
          const k = t.split(".");
          if (k.length > 1)
            for (let x = 0; x < k.length && !(!(x == k.length - 1) && !ae(v)); x++)
              ae(v) && (v = v[k[x]]);
          else
            f = t;
          v && (v[f] = r);
    ...
    defineFieldValue(t, r) {
      ...
      return r && typeof r == "object" && (r = this.createObservable(r, t, t)), r = N.box(r), Reflect.defineProperty(this, f.name, {
        ...
        set: (u) => {
          dt(() => r.set(u)), this.produceDraft(f.name, r.get()), this.checkChange(f.name, r.get());
        },
        enumerable: !0,
        configurable: !0
      }), r;
     ...
     */
    checkChange(t, r) {
      const f = C(r), u = C(Reflect.get(this.committedData, t)) || C(Reflect.get(this.initData, t)), _ = t && t in this.initData && !ft(u, f);
      return dt(() => {
        _ && Reflect.set(this.modified_, t, C(u) || u);
        for (const O in this.modified_)
          t === O && t in this.modified_ && ft(u, f) && delete this.modified_[O];
      }), _;
    }
    /**
    ...
    A = [N, F], U = [N, F], d = [N, F], z = [F], Y = [N, F], q = [N, F], lt = [N, F], kt = [N, F], At = [F], Et = [F], zt = [F], Lt = [F], Kt = [R], Yt = [F], Bt = [R], Ut = [et], $t = [R], Wt = [R], Jt = [R], Xt = [R], qt = [R], Qt = [R], Zt = [R], te = [et], ee = [et], ie = [(m = et).struct.bind(m)], y(e, null, A, { kind: "accessor", name: "initData", static: !1, private: !1, access: { has: (t) => "initData" in t, get: (t) => t.initData, set: (t, r) => {
      t.initData = r;
      ...
      t.committedData = r;
    } }, metadata: I }, nt, T), y(e, null, d, { kind: "accessor", name: "modified_", static: !1, private: !1, access: { has: (t) => "modified_" in t, get: (t) => t.modified_, set: (t, r) => {
      t.modified_ = r;
      ...
      t.inverseChanges = r;
    } }, metadata: I }, at, rt), y(e, null, lt, { kind: "accessor", name: "history", static: !1, private: !1, access: { has: (t) => "history" in t, get: (t) => t.history, set: (t, r) => {
      t.history = r;
    } }, metadata: I }, Mt, St), y(e, null, kt, { kind: "accessor", name: "historyIndex", static: !1, private: !1, access: { has: (t) => "historyIndex" in t, get: (t) => t.historyIndex, set: (t, r) => {
      t.historyIndex = r;
    } }, metadata: I }, wt, Tt), y(e, null, Kt, { kind: "method", name: "resetToDefault", static: !1, private: !1, access: { has: (t) => "resetToDefault" in t, get: (t) => t.resetToDefault }, metadata: I }, null, p), y(e, null, Bt, { kind: "method", name: "produceDraft", static: !1, private: !1, access: { has: (t) => "produceDraft" in t, get: (t) => t.produceDraft }, metadata: I }, null, p), y(e, null, Ut, { kind: "getter", name: "dirty", static: !1, private: !1, access: { has: (t) => "dirty" in t, get: (t) => t.dirty }, metadata: I }, null, p), y(e, null, $t, { kind: "method", name: "commit", static: !1, private: !1, access: { has: (t) => "commit" in t, get: (t) => t.commit }, metadata: I }, null, p), y(e, null, Wt, { kind: "method", name: "commitField", static: !1, private: !1, access: { has: (t) => "commitField" in t, get: (t) => t.commitField }, metadata: I }, null, p), y(e, null, Jt, { kind: "method", name: "reject", static: !1, private: !1, access: { has: (t) => "reject" in t, get: (t) => t.reject }, metadata: I }, null, p), y(e, null, Xt, { kind: "method", name: "toInit", static: !1, private: !1, access: { has: (t) => "toInit" in t, get: (t) => t.toInit }, metadata: I }, null, p), y(e, null, qt, { kind: "method", name: "undo", static: !1, private: !1, access: { has: (t) => "undo" in t, get: (t) => t.undo }, metadata: I }, null, p), y(e, null, Qt, { kind: "method", name: "redo", static: !1, private: !1, access: { has: (t) => "redo" in t, get: (t) => t.redo }, metadata: I }, null, p), y(e, null, Zt, { kind: "method", name: "goToHistory", static: !1, private: !1, access: { has: (t) => "goToHistory" in t, get: (t) => t.goToHistory }, metadata: I }, null, p), y(e, null, te, { kind: "getter", name: "validation", static: !1, private: !1, access: { has: (t) => "validation" in t, get: (t) => t.validation }, metadata: I }, null, p), y(e, null, ee, { kind: "getter", name: "validAndDirty", static: !1, private: !1, access: { has: (t) => "validAndDirty" in t, get: (t) => t.validAndDirty }, metadata: I }, null, p), y(e, null, ie, { kind: "getter", name: "service", static: !1, private: !1, access: { has: (t) => "service" in t, get: (t) => t.service }, metadata: I }, null, p), y(null, null, g, { kind: "field", name: h, static: !1, private: !1, access: { has: (t) => h in t, get: (t) => t[h], set: (t, r) => {
      t[h] = r;
    } }, metadata: I }, D, S), y(null, null, z, { kind: "field", name: "draft", static: !1, private: !1, access: { has: (t) => "draft" in t, get: (t) => t.draft, set: (t, r) => {
      t.draft = r;
    } }, metadata: I }, E, w), y(null, null, At, { kind: "field", name: "initializedFields", static: !1, private: !1, access: { has: (t) => "initializedFields" in t, get: (t) => t.initializedFields, set: (t, r) => {
      t.initializedFields = r;
    } }, metadata: I }, Vt, xt), y(null, null, Et, { kind: "field", name: "legacyInitDone", static: !1, private: !1, access: { has: (t) => "legacyInitDone" in t, get: (t) => t.legacyInitDone, set: (t, r) => {
      t.legacyInitDone = r;
    } }, metadata: I }, Rt, jt), y(null, null, zt, { kind: "field", name: "rawInitData", static: !1, private: !1, access: { has: (t) => "rawInitData" in t, get: (t) => t.rawInitData, set: (t, r) => {
      t.rawInitData = r;
    } }, metadata: I }, Ft, Pt), y(null, null, Lt, { kind: "field", name: "options", static: !1, private: !1, access: { has: (t) => "options" in t, get: (t) => t.options, set: (t, r) => {
      t.options = r;
    } }, metadata: I }, Ct, Ht), y(null, null, Yt, { kind: "field", name: "historyMuted", static: !1, private: !1, access: { has: (t) => "historyMuted" in t, get: (t) => t.historyMuted, set: (t, r) => {
      t.historyMuted = r;
    } }, metadata: I }, Gt, Nt), I && Object.defineProperty(e, Symbol.metadata, { enumerable: !0, configurable: !0, writable: !0, value: I });
  })(), e;
})();
...
let mi = (() => {
  var e, n, c;
  let o = [], i, s = [], a = [], l, h = [], m = [], p, g, D, S, A, L, K, U, nt;
  return e = class {
    get items() {
      return W(this, n, "f");
    }
    ...
    constructor() {
      n.set(this, (b(this, o), b(this, s, []))), c.set(this, (b(this, a), b(this, h, []))), b(this, m), mt(this), this.autoAttachDevtools();
    }
    add(d) {
    ...
    autoAttachDevtools() {
      ...
      const lt = (G = (Y = q.devtools) === null || Y === void 0 ? void 0 : Y.instanceId) !== null && G !== void 0 ? G : `${at}#${rt}`;
      Xe(this, { name: at, instanceId: lt });
    }
...
function Ii(e, n) {
  return Me((c = {}) => {
    ...
    if (ke(() => {
      ...
      return j(yt.metadataKey, a, i), n(Object.assign({ viewModel: i }, c));
    }
