...
// Windows temporarily needs this file, https://github.com/module-federation/vite/issues/68
    ...
    const importMap = {
        ...
        "mobx": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__mobx__prebuild__.js");
            return pkg;
        }
      ,
        "mobx-react": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__mobx_mf_2_react__prebuild__.js");
            return pkg;
        }
      ,
        "mobx-react-lite": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__mobx_mf_2_react_mf_2_lite__prebuild__.js");
            return pkg;
        }
      ,
        "react": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__react__prebuild__.js");
            return pkg;
        }
      ,
        "react-dom": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__react_mf_2_dom__prebuild__.js");
            return pkg;
        }
      ,
        "rvm-toolkit": async () => {
          let pkg = await import("__mf__virtual/mf5ka__prebuild__rvm_mf_2_toolkit__prebuild__.js");
            return pkg;
        }
